...
if __name__ == '__main__':
    ...
    parser.add_argument('--sample_path', default='sampled_results', type=str)
    ...
    parser.add_argument('--protein_root', type=str, default='/home/huangzl/Data/datasets/molecule/targetdiff/crossdocked_v1.1_rmsd1.0')
    ...
    result_path = os.path.join('./', 'eval_results')
